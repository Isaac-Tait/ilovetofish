  ...
  return (
    <div className='heropattern-topography-neutral-100'>
      ...
      <div className='h-screen max-w-6xl mx-auto overflow-y-scroll px-1'>
        ...
        >
          Last week my brother and his family were in town. It was
          great to see him and his family (the last time I saw them
          was under less than ideal{' '}
          <Link
        ...
        <p>
          The Fourth of July weekend was relaxing and I got a lot of
          yard work done. Come Wednesday though I was itching for a
          bit of fishing action. So, I decided to re-visit an area I
          had been to before.
        </p>
        ...
        <p>
          The water was a bit low, which was a bit concerning. We got
          about four inches of rain in the month of June. I thought
          that was a pretty good amount - I guess not. A lot of the
          rivers are low. Hopefully things improve over the next month
          or two. I am skeptical though as July and August are the dry
          months around here (so I am told).
        </p>
        <div className='flex justify-center'>
          <Image
        ...
        <p className='flex justify-center text-xs italic'>
          Whoa! Look at that beautiful Rainbow Trout. She had an
          equally large Brown Trout friend but I could not catch him
        </p>
        <div className='flex justify-center'>
          <Image
        ...
        <p className='flex justify-center text-xs italic'>
          What an epic looking stream. It was as warm as a bath tub
          and loaded with spunky Bass. I bet it is an epic segment in
          the early Spring...
        </p>
        <div className='flex justify-center'>
          <Image
        ...
        <p className='flex justify-center text-xs italic'>
          Fresh water mussels were everywhere!
        </p>
        <div className='flex justify-center'>
          <Image
        ...
        <p>
          I also tried out a new app called Merlin Bird ID. It was
          really cool. I was able to have it listen to bird calls and
          identify them in real time. At the days high point on the
          river exploration, I heard a Red-shouldered hawk, American
          Crows, Veery, Gray Catbirds, and a Northern Cardinal. The
          symphony was superb.
        </p>
      </div>
