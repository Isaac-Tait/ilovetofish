    ...
    return (
        <div className='heropattern-topography-neutral-100'>
            ...
            <div className='h-screen max-w-6xl mx-auto overflow-y-scroll px-1'>
                ...
                >Well my second fall in Connecticut started on a good note. I was able to get out for a great, albeit, chilly day of fishing on a river not too far from home. Last year my first blog post here was about a local{' '}<a 
                ...
                <p>Well this week I discovered a new field of boulders while I was out scoping a new area to do some kayak (and maybe stream) fishing. I am looking forward to returning the area soon with my bouldering gear and do some exploring...</p>
                ...
                <p>I shot this video with my new iPhone 14 Pro. I have been having a lot of fun shooting some great footage with my new toy. It is by far and away much better than my iPhone 11 was.</p>
                ...
                <p>Last week my son brought home a cold from school. Of course he was sick one night (while I was trying to sleep) and then a few days latter I got it and I have been feeling pretty cruddy for the last five or six days. Not bad enough though to keep me inside though.</p>
                <p>I managed several trips in the past week or so. One to a large lake that had not one but two rivers flowing into it. The first river I saw several large bass and came across an absolutely beautiful rocky pool. The fish catching action was slow though so I hopped back in the kayak and made my way to the second river. Along the way I fished the lake for a bit and caught & released several nice Perch and Sunfish.</p>
                ...
                <p>Last week, when Hurricane Fiona was making its way north along the United States&#39; east coast, New England was graced with a surprise storm out of Canada that also brought with it a cold front. I watched with amazement as my home weather station&#39;s thermometer showed a precipitous drop of 14 degrees (Fahrenheit) in just two minutes or so.</p>
                ...
                <div className='flex justify-center mb-4'>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/C8SZPr1D-yc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
