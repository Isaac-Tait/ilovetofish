  ...
  return (
    <div className='heropattern-topography-neutral-100'>
      ...
      <div className='h-screen max-w-6xl mx-auto overflow-y-scroll px-1'>
        ...
        >
          Well my second fall in Connecticut started on a good note. I
          was able to get out for a great, albeit, chilly day of
          fishing on a river not too far from home. Last year my first
        ...
        <p>
          Well this week I discovered a new field of boulders while I
          was out scoping a new area to do some kayak (and maybe
          stream) fishing. I am looking forward to returning to the
          area soon with my bouldering gear and do some exploring...
        </p>
        ...
        <p>
          I shot this video with my new iPhone 14 Pro. I have been
          having a lot of fun shooting some great footage with my new
          tool. It is by far and away much better than my iPhone 11
          was.
        </p>
        ...
        <p>
          Last week my son brought home a cold from school. Of course
          he was sick one night (while I was trying to sleep) and then
          a few days latter I got it and I have been feeling pretty
          cruddy for the last five or six days. Not bad enough though
          to keep me inside.
        </p>
        <p>
          I managed several trips in the past week or so. One to a
          large lake that had not one but two rivers flowing into it.
          The first river I saw several large bass and came across an
          absolutely beautiful rocky pool. The fish catching action
          was slow though so I hoped back in the kayak and made my way
          to the second river. Along the way I fished the lake for a
          bit and caught & released several nice Perch and Sunfish.
        </p>
        <p>
          The second river was loaded with Perch and I found that if I
          backed the tension on my bait casting reel ALL the way I
          could lob my lightest lure. That lure was driving the fish
          nuts and I had quite a bit of luck on the second river. My
          hands were freezing though and I had quite a bit of back
          tracking to do to get back to my truck in time so that I
          would not be late to get my son from school. So, I had to
          cut the fishing short and head back.
        </p>
        ...
        <p className='flex justify-center text-xs italic'>
          I found this random mirror in the woods, and of course I had
          to snap a photo...
        </p>
        <p>
          Last week, when Hurricane Fiona was making its way north
          along the United States&#39; east coast, New England was
          graced with a surprise storm out of Canada that also brought
          with it a cold front (this storm also kept Fiona out in the
          ocean...). I watched with amazement as my home weather
          station&#39;s thermometer showed a precipitous drop of 14
          degrees (Fahrenheit) in just twenty minutes or so.
        </p>
        <p>
          The next day, despite the unseasonably cool weather I went
          fishing. I was not expecting too much action due to the
          sudden change in temperature. And so, I was pleasantly
          surprised when I landed numerous fish. It was a great day
          out and quite chilly. Every spot in the river where the
          canopy opened up and let in the sun I was very grateful for.
          I put together a video of the escapade. You can watch it
          below
        </p>
        ...
        <p className='text-center mb-2'>
          Lastly, I will leave you with a collage of photos taken
          during the last week or so of my travels around Connecticut
          in search of my favorite quarry - fish!
        </p>
