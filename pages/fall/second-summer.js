    ...
    return (
        <div className='heropattern-topography-neutral-100'>
            ...
            <div className='h-screen max-w-6xl mx-auto overflow-y-scroll px-1'>
                ...
                >year</Link>.</p>
                <p>When I pulled up to the trail-head on Monday the lot was nearly full (well three cars had parked in such a way as to fill up a six car lot) so, I squeezed in between a few trees with my truck and doused myself in tick spray and headed off into the woods in search of some trout.</p>
                ...
                <p className='flex justify-center text-xs italic'>Thank you Lord for Connecticut!</p>
                ...
                <p>It was to be the first and last fish of the day, which was fine by me. It was actually kind of hot in the sun as I had dressed for cooler temperatures. I kept my eyes peeled for mushrooms on the way back but did not really see any - just a pheasant hunter way off in the woods. It was a reminder that we were in the thick of hunting season and that I should probably start wearing my flash orange gear while hiking to and from the river so as not to be mistaken for something somebody wants for the freezer in their garage...</p>
                <div className='flex justify-center'>
                    <Image 
                ...
                <p className='flex justify-center text-xs italic'>A choice spot down low on the river on day one..</p>
                <p className='mb-1'>I was seeing a lot of fish in the river and even had several that chased my lure but no takers. I was starting to think that the river was just too cold to elicit much action until I came to a really nice spot higher up the river than I had ever been before.</p>
                <div className='flex justify-center'>
                    <Image 
