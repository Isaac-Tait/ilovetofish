  ...
  return (
    <div className='heropattern-topography-neutral-100'>
      ...
      <div className='h-screen max-w-6xl mx-auto overflow-y-scroll px-1'>
        ...
        >
          I compiled this playlist of Pat Metheny music and I listen
          to it at least twice a week. The first song my son ever
          heard was &quot;The Truth Will Alway Be&quot; the long
          crescendo is phenomenal to listen to whether it is your
          first time or your millionth time hearing the song. I love
          this song so much I want it played at my funeral.
        </p>
        <p className='mt-2'>
          &quot;To The End of the World&quot; is another one of my
          favorites and also one of his longest recorded songs to
          boot.
        </p>
        <iframe
        ...
        <p className='text-center font-medium mt-8'>
          Back in 2018 my brother and I got to see Pat Metheny play
          live in Portland Oregon. It was hands down the best concert
        ...
        <p className='flex justify-center text-xs'>
          My youngest brother and I psyched for the concert to start -
          do not mind the creepy dude in the background&nbsp;
