  ...
  return (
    <>
      <nav className='flex items-center flex-wrap p-3 '>
        <Link href='/'>
          <a className='inline-flex items-center p-2 mr-4 lg:w-1/3 text-amber-400 text-6xl'>
        ...
        >
          <div className='lg:inline-flex lg:flex-row lg:ml-auto lg:w-auto w-full lg:items-center items-start flex flex-col lg:h-auto'>
            <Link href='/fallfish-tenkara'>
              <a className='lg:inline-flex lg:w-auto w-full px-3 py-2 rounded text-amber-400 font-bold items-center justify-center hover:bg-indigo-200 hover:text-white'>
                Fallfish Tenkara
              </a>
            </Link>
            <Link href='/about'>
