    ...
    <div className='heropattern-bubbles-neutral-100 h-screen overflow-y-auto'>
      ...
      <div className='max-w-6xl mx-auto px-1'>
        ...
        <p>
          ...
          running, cycling, skiing, rock climbing, && backpacking. I
          also enjoy cooking vegan meals at home and listening to
          jazz.
        </p>
        <p>
          To stay up to date with blog posts follow me on Instagram
          (the link is below
          <span aria-label='finger pointing down' role='img'>
            &#128071;
          </span>
          )
        </p>
      ...
      <div className='flex justify-center mb-8'>
        ...
        >
          <svg
            ...
            height='16'
            fill='currentColor'
            className='text-blue-500 h-12 w-12 my-8'
            viewBox='0 0 16 16'
          >
