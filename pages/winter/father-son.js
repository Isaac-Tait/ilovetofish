  ...
  return (
    <div className='heropattern-topography-neutral-100'>
      ...
      <div className='h-screen max-w-6xl mx-auto overflow-y-scroll px-1'>
        ...
        >
          Tuesday morning dawned cold and cloudy. The thought of being
          stuck at home all day was just too repulsive. So, I packed
          up our gear, kissed the wife goodbye, and headed north with
          my son for a cross country ski trip. We had three days to
          ski before the warm rain settled in for at least a week.
          With two years of La Nina weather back to back you have to
          squeeze in every opportunity to ski as the snowpack is not
          guaranteed to be around next week. I shared many photos and{' '}
          <Link
        ...
        <p className='flex justify-center text-xs italic'>
          The day after returning from our ski trip we headed to the
          beach. New England is a spectacular place!
        </p>
