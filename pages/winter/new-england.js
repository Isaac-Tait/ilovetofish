    ...
    return (
        <div className='heropattern-topography-neutral-100'>
            ...
            <div className='h-screen max-w-6xl mx-auto overflow-y-scroll px-1'>
                ...
                >trail</Link> with my skis). Instead there was an eighth of an inch of snow and thinning fast from the 33&#176; rain.</p>
                ...
                <Link 
                    ...
                    rel="noopener noreferrer" 
                    className='underline text-teal-400 hover:text-indigo-400'
                >channel</Link> I have 30+ videos mixed to a sound track. For this video though I felt it was better to highlight the natural soundtrack. Listen closely and you will hear{' '}
                 <Link 
                    href='https://seattlebackpackersmagazine.com/cherish-the-silence-of-nature/'
                    target="_blank" 
                    rel="noopener noreferrer" 
                    className='underline text-teal-400 hover:text-indigo-400'
                >the silence of nature</Link>. The video was shot over the course of several months and numerous trips into the wild places of Connecticut.</p>
